...
public class BankAccount {
	...
	public long withdraw(long money) throws BankAccountException {  // money : 요청된 금액
		...
		if (money <= 0) {
			...
			throw new BankAccountException("통장잔고가 부족합니다.", 2001);
		}
			this.balance -= money;
	...
	// 이체 : transfer method
	public void transfer( BankAccount who, long money) throws BankAccountException {
		
		// ** 사용방법 
		// 내 통장에서 출금된 금액을 네 통장에 입금해 준다.
		who.deposit( withdraw(money) );
		// (입금,출금)이 실행되면 무조건 예외를 던져준다. 
		// 이것 때문에 해당 문에서도 throws를  해준다.
