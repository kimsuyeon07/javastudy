...
/*
     	...
     	1. 자바의 세부 작업 단위입니다.
     	2. 생성 방법 (택 1)
     	   1) Thread 클래스를 상속 받습니다. (extends Thread) => 이 방법이 조금 더 쉽다.(다중 상속이 되지 않아서 많이 사용되지는 않는다)
     	   2) Runnable 인터페이스를 구현합니다. (implements Runnable) => 많이 사용되는 방법
     	3. 기본 규칙 : 약속(꼭 사용하는 메서드.)
